  ...
  <div>
   ...
   <!--子表表格tab-->
    <a-tabs defaultActiveKey="1">
        <a-tab-pane tab="民政小区信息" key="1" >
           <MzVillageInfoList/>
        </a-tab-pane>
     </a-tabs>
    <!-- 表单区域 -->
    <MzCommunityInfoModal @register="registerModal" @success="handleSuccess"></MzCommunityInfoModal>
  </div>
</template>

<script lang="ts" name="shequ-mzCommunityInfo" setup>
